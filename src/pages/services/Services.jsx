...
export const Services = () => {
  ...
  const servicesData = [
    ...
    },
    {
      ...
      image: "https://static01.nyt.com/images/2024/04/10/multimedia/10best-restaurants-chicago13-hpqj/08best-restaurants-chicago13-hpqj-videoSixteenByNine3000.jpg"
    },
    {
      id: 4,
      title: "Food Delivery",
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.9 }}
                  onClick={handleCloseDialog}
                  className="absolute top-4 right-4 bg-gradient-to-b from-red-500 to-red-700 text-white p-2 rounded-full z-10"
                >
                  <CloseIcon />
                </motion.button>
  ...
  return (
    <div className="bg-gray-900 rounded-2xl p-6 h-full flex flex-col border border-gray-800 hover:border-amber-500/50 transition-all duration-300 group">
      ...
      <motion.button
        ...
        className="bg-gradient-to-b from-blue-500 to-indigo-700 text-white font-medium flex items-center justify-center space-x-1 group-hover:space-x-2 transition-all"
      >
